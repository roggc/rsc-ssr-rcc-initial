async function fillJSXwithClientComponents(jsx) {
  if (typeof jsx === "string" || typeof jsx === "number" || typeof jsx === "boolean" || jsx == null) {
    ...
    return Promise.all(jsx.map(async child => await fillJSXwithClientComponents(child)));
    ...
    if (jsx.$$typeof === Symbol.for("react.element")) {
      ...
      return Object.fromEntries(await Promise.all(Object.entries(jsx).map(async ([propName, value]) => [propName, await fillJSXwithClientComponents(value)])));
    }
  } else throw new Error("Not implemented");
}

export { fillJSXwithClientComponents };
